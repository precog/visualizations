...
rg.controller.MVPOptions.complete = function(executor,parameters,handler) {
	...
	chain.addAction(function(params,handler1) {
		...
		haxe.Log.trace(Dynamics.string(params),{ fileName : "MVPOptions.hx", lineNumber : 384, className : "rg.controller.MVPOptions", methodName : "complete"});
		handler1(params);
	});

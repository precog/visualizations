...
rg.controller.info.InfoHeatGrid.filters = function() {
	return [{ field : "contour", validator : function(v) {
		...
		return [{ field : "startColor", value : rg.view.svg.util.RGColors.parse(v,rg.controller.info.InfoHeatGrid.defaultStartColor.hex("#"))}];
	}},{ field : "endcolor", validator : function(v) {
		return Std["is"](v,String);
	}, filter : function(v) {
		return [{ field : "endColor", value : rg.view.svg.util.RGColors.parse(v,rg.controller.info.InfoHeatGrid.defaultEndColor.hex("#"))}];
	}}].concat(rg.controller.info.InfoCartesianChart.filters());
}

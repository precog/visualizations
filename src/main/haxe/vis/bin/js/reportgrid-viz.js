...
rg.track.Tracker = function(executor,paths,token) {
...
rg.track.Tracker.prototype.executor = null;
rg.track.Tracker.prototype.storage = null;
rg.track.Tracker.prototype.paths = null;
rg.track.Tracker.prototype.token = null;
rg.track.Tracker.prototype.engagements = null;
rg.track.Tracker.prototype.visualizations = null;
rg.track.Tracker.prototype.start = null;
rg.track.Tracker.prototype.delaypos = null;
rg.track.Tracker.prototype.visits = null;
rg.track.Tracker.prototype.updateVisits = function() {
...
rg.track.Tracker.prototype.addEngagement = function(visualization) {
...
rg.track.Tracker.prototype.addVisualization = function(visualization,params) {
...
rg.track.Tracker.prototype.trackVisualization = function(visualization,params) {
	...
	})($closure(this,"trackInteraction"),vis,"over"));
	container.onNode("click.track",(function(f,a1,a2) {
		return function(a3,a4) {
			return f(a1,a2,a3,a4);
		};
	})($closure(this,"trackInteraction"),vis,"click"));
	this.execute({ visualization : event});
}
rg.track.Tracker.prototype.createEngagementDelay = function() {
	...
	haxe.Timer.delay($closure(this,"updateEngagementTime"),1000 * delay);
	this.delaypos++;
}
rg.track.Tracker.prototype.trackInteraction = function(visualization,action,_,_1) {
...
rg.track.Tracker.prototype.trackEngagements = function() {
...
rg.track.Tracker.prototype.delayedTrackVisits = function(isfirstvisit) {
	var me = this;
...
rg.track.Tracker.prototype.trackFirstVisit = function() {
	var event = this.visitEvent();
	this.execute({ first_visit : event});
}
rg.track.Tracker.prototype.trackVisit = function() {
	var event = this.visitEvent();
	event["visits"] = this.visits;
	this.execute({ visit : event});
}
rg.track.Tracker.prototype.updateEngagementTime = function() {
	this.storage.setItem(rg.track.Tracker.KEY_ENGAGEMENT_TIME,"" + this.delaypos);
	this.createEngagementDelay();
}
rg.track.Tracker.prototype.extractEngagements = function() {
...
rg.track.Tracker.prototype.bucketTime = function(pos) {
...
rg.track.Tracker.prototype.engKey = function(key) {
	return rg.track.Tracker.PREFIX + "eng_" + key;
}
rg.track.Tracker.prototype.remove = function(key) {
	var v = this.storage.getItem(key);
	this.storage.removeItem(key);
	return v;
}
rg.track.Tracker.prototype.execute = function(params) {
...
rg.track.Tracker.prototype.baseEvent = function() {
...
rg.track.Tracker.prototype.visitEvent = function() {
...
rg.track.Tracker.prototype.__class__ = rg.track.Tracker;
...
rg.view.svg.widget.Map = function(container,projection) {
	if( container === $_ ) return;
...
rg.view.svg.widget.Map.prototype.className = null;
rg.view.svg.widget.Map.prototype.map = null;
rg.view.svg.widget.Map.prototype.onReady = null;
rg.view.svg.widget.Map.prototype.click = null;
rg.view.svg.widget.Map.prototype.labelDataPoint = null;
rg.view.svg.widget.Map.prototype.labelDataPointOver = null;
rg.view.svg.widget.Map.prototype.radius = null;
rg.view.svg.widget.Map.prototype.colorMode = null;
rg.view.svg.widget.Map.prototype.projection = null;
rg.view.svg.widget.Map.prototype.g = null;
rg.view.svg.widget.Map.prototype.load = function(path,type,usejsonp) {
	switch(type) {
	case "geojson":
...
rg.view.svg.widget.Map.prototype.loadGeoJson = function(path,usejsonp) {
	if(usejsonp) this.loadGeoJsonJsonp(path); else this.loadGeoJsonAjax(path);
}
rg.view.svg.widget.Map.prototype.loadGeoJsonJsonp = function(path) {
	var api = ReportGrid.$.Http.Jsonp.get;
	api(path,{ success : $closure(this,"draw")});
}
rg.view.svg.widget.Map.prototype.loadGeoJsonAjax = function(path) {
	var me = this;
...
rg.view.svg.widget.Map.prototype.draw = function(json) {
...
rg.view.svg.widget.Map.prototype.onMouseOver = function(dp,_,_1) {
	this.handlerDataPointOver(dp,this.labelDataPointOver);
}
rg.view.svg.widget.Map.prototype.onClick = function(dp,_,_1) {
	this.handlerClick(dp,this.click);
}
rg.view.svg.widget.Map.prototype.handlerDataPointOver = null;
rg.view.svg.widget.Map.prototype.handlerClick = null;
rg.view.svg.widget.Map.prototype.setClassName = function(cls) {
	this.g.attr("class").string("map" + (null == cls?"":" " + cls));
	return cls;
}
rg.view.svg.widget.Map.prototype.__class__ = rg.view.svg.widget.Map;
...
rg.controller.info.InfoMap.fromTemplate = function(t) {
	...
	case "world":case "world-countries":
		return [{ field : "projection", value : "mercator"},{ field : "url", value : "geo/json/" + "world-countries.json.js"}];
	case "usa-states":
		return [{ field : "projection", value : "albersusa"},{ field : "url", value : "geo/json/" + "usa-states.json.js"}];
	case "usa-state-centroids":
		return [{ field : "projection", value : "albersusa"},{ field : "url", value : "geo/json/" + "usa-state-centroids.json.js"}];
	case "usa-counties":
		return [{ field : "projection", value : "albersusa"},{ field : "url", value : "geo/json/" + "usa-counties.json.js"}];
	default:
		return (function($this) {
			var $r;
			throw new thx.error.Error("invalid template",null,null,{ fileName : "InfoMap.hx", lineNumber : 180, className : "rg.controller.info.InfoMap", methodName : "fromTemplate"});
			return $r;
		}(this));
	}
}
...
rg.controller.info.InfoMap.prototype.usejson = null;
...
rg.controller.info.InfoTrack = function(p) {
	if( p === $_ ) return;
	this.enabled = true;
...
rg.controller.info.InfoTrack.prototype.enabled = null;
rg.controller.info.InfoTrack.prototype.token = null;
rg.controller.info.InfoTrack.prototype.paths = null;
rg.controller.info.InfoTrack.prototype.hash = null;
rg.controller.info.InfoTrack.prototype.__class__ = rg.controller.info.InfoTrack;
...
rg.JSBridge.main = function() {
	...
	r.info.viz = { version : "1.0.1.878"};
}
rg.JSBridge.select = function(el) {
	var s = Std["is"](el,String)?thx.js.Dom.select(el):thx.js.Dom.selectNode(el);
	if(s.empty()) throw new thx.error.Error("invalid container '{0}'",el,null,{ fileName : "JSBridge.hx", lineNumber : 125, className : "rg.JSBridge", methodName : "select"});
	return s;
}
...
rg.view.layout.Layout.prototype.width = null;
rg.view.layout.Layout.prototype.height = null;
...
rg.controller.info.InfoStreamGraph.prototype.segment = null;
...
rg.controller.App = function(executor,tracker) {
	if( executor === $_ ) return;
	this.executor = executor;
...
rg.controller.App.prototype.tracker = null;
...
js.Storage.prototype.length = null;
js.Storage.prototype.key = null;
js.Storage.prototype.getItem = null;
js.Storage.prototype.setItem = null;
js.Storage.prototype.removeItem = null;
js.Storage.prototype.clear = null;
js.Storage.prototype.__class__ = js.Storage;
...
js.CookieStorageFallback = function(p) {
	if( p === $_ ) return;
	this.length = Iterators.array(js.Cookie.all().keys()).length;
}
js.CookieStorageFallback.__name__ = ["js","CookieStorageFallback"];
js.CookieStorageFallback.prototype.length = null;
js.CookieStorageFallback.prototype.key = function(index) {
	var keys = Iterators.array(js.Cookie.all().keys());
	return keys[index];
}
js.CookieStorageFallback.prototype.getItem = function(key) {
	return js.Cookie.get(key);
}
js.CookieStorageFallback.prototype.setItem = function(key,value) {
...
js.CookieStorageFallback.prototype.removeItem = function(key) {
	this.length--;
	js.Cookie.remove(key,js.CookieStorageFallback.DEFAULT_PATH);
}
js.CookieStorageFallback.prototype.clear = function() {
	var keys = Iterators.array(js.Cookie.all().keys());
	var _g = 0;
	while(_g < keys.length) {
		var key = keys[_g];
...
js.CookieStorageFallback.prototype.__class__ = js.CookieStorageFallback;
...
rg.data.source.rgquery.ITrackReportGrid.prototype.track = null;
rg.data.source.rgquery.ITrackReportGrid.prototype.__class__ = rg.data.source.rgquery.ITrackReportGrid;
rg.track.DebugExecutor = function(p) {
}
rg.track.DebugExecutor.__name__ = ["rg","track","DebugExecutor"];
rg.track.DebugExecutor.prototype.track = function(path,events,success,error,token) {
...
rg.track.DebugExecutor.prototype.__class__ = rg.track.DebugExecutor;
...
js.LocalStorage.prototype.__class__ = js.LocalStorage;
...
rg.controller.info.InfoScatterGraph.prototype.segment = null;
...
Hashes.prototype.__class__ = Hashes;
...
rg.controller.MVPOptions.complete = function(executor,opt,handler) {
	...
	chain.addAction(function(opt1,handler1) {
		if(null == opt1.track) opt1.track = { enabled : true};
		if(opt1.track.enabled) {
			opt1.track = { enabled : true, hash : "FAKEHASH"};
			handler1(opt1);
		} else handler1(opt1);
	});
	chain.addAction(function(opt1,handler1) {
...
rg.controller.info.InfoLabelPivotTable.prototype.axisvalue = null;

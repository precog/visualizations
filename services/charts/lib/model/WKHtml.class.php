...
class model_WKHtml {
	...
	public function renderUrl($path) {
		...
		haxe_Log::trace("CMD " . model_WKHtml::cmdToString($this->cmd, $args), _hx_anonymous(array("fileName" => "WKHtml.hx", "lineNumber" => 48, "className" => "model.WKHtml", "methodName" => "renderUrl")));

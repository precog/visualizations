...
class controller_UploadForm extends ufront_web_mvc_Controller {
	...
	static $__rtti = "<class path=\"controller.UploadForm\" params=\"\" module=\"controller.UploadFormController\">\x0A\x09<extends path=\"ufront.web.mvc.Controller\"/>\x0A\x09<display public=\"1\" set=\"method\" line=\"9\"><f a=\"?html:?config:?displayFormat\">\x0A\x09<c path=\"String\"/>\x0A\x09<c path=\"String\"/>\x0A\x09<c path=\"String\"/>\x0A\x09<d/>\x0A</f></display>\x0A\x09<lastError><c path=\"String\"/></lastError>\x0A\x09<gist public=\"1\" set=\"method\" line=\"63\"><f a=\"?gistid\">\x0A\x09<c path=\"String\"/>\x0A\x09<c path=\"ufront.web.mvc.ActionResult\"/>\x0A</f></gist>\x0A\x09<validateGist set=\"method\" line=\"82\"><f a=\"id\">\x0A\x09<c path=\"String\"/>\x0A\x09<c path=\"String\"/>\x0A</f></validateGist>\x0A\x09<new public=\"1\" set=\"method\" line=\"7\"><f a=\"\"><e path=\"Void\"/></f></new>\x0A</class>";

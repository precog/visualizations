...
class controller_HomeController extends ufront_web_mvc_Controller {
	...
	public function index() {
		return new ufront_web_mvc_ContentResult(_hx_deref(new template_Home())->execute(_hx_anonymous(array("baseurl" => "http://localhost", "url" => new ufront_web_mvc_view_UrlHelperInst($this->controllerContext->requestContext), "sampleuid" => model_Sample::$uid, "version" => App::$version))), null);
	}

...
rg.view.html.widget.LogoPosition = $hxClasses["rg.view.html.widget.LogoPosition"] = { __ename__ : ["rg","view","html","widget","LogoPosition"], __constructs__ : ["TopLeft","TopRight","BottomLeft","BottomRight","Before","After"] }
rg.view.html.widget.LogoPosition.TopLeft = ["TopLeft",0];
...
rg.view.html.widget.LogoPosition.TopRight = ["TopRight",1];
...
rg.view.html.widget.LogoPosition.BottomLeft = ["BottomLeft",2];
...
rg.view.html.widget.LogoPosition.BottomRight = ["BottomRight",3];
...
rg.view.html.widget.LogoPosition.Before = ["Before",4];
...
rg.view.html.widget.LogoPosition.After = ["After",5];
...
rg.view.html.widget.Logo = $hxClasses["rg.view.html.widget.Logo"] = function(container,darkbackground,position) {

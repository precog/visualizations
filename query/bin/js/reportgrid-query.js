...
rg.app.query.JSBridge.main = function() {
	...
	r.info.query = { version : "1.5.15.8972"};
...
if(!rg.data) rg.data = {}
rg.data.IExecutorReportGrid = $hxClasses["rg.data.IExecutorReportGrid"] = function() { }
...
rg.data.ReportGridExecutorCache = $hxClasses["rg.data.ReportGridExecutorCache"] = function(executor,storage,timeout) {
...
thx.error.Error.prototype = $extend(thx.util.Message.prototype,{
	toString: function() {
		try {
			...
			console.log("wrong parameters passed for pattern '" + this.message + "' at " + ps);
			return "";
		}
	}

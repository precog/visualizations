...
rg.controller.info.InfoDataContextReportGrid = $hxClasses["rg.controller.info.InfoDataContextReportGrid"] = function() {
	rg.controller.info.InfoDataContext.call(this);
}
rg.controller.info.InfoDataContextReportGrid.__name__ = ["rg","controller","info","InfoDataContextReportGrid"];
rg.controller.info.InfoDataContextReportGrid.filters = function() {
	var filters = rg.controller.info.InfoDataContext.filters();
	Arrays.removef(filters,function(item) {
		return item.field == "src";
	});
	return filters.concat([{ field : "src", validator : function(v) {
		return Std["is"](v,Array) && Iterators.all(v.iterator(),function(v1) {
			return Reflect.isObject(v1) && null == Type.getClass(v1);
		}) || Reflect.isObject(v) && null == Type.getClass(v);
	}, filter : function(v) {
		var result = Std["is"](v,Array)?v.map(function(v1,i) {
			return rg.controller.info.Info.feed(new rg.controller.info.InfoDataSourceReportGrid(),v1);
		}):[rg.controller.info.Info.feed(new rg.controller.info.InfoDataSourceReportGrid(),v)];
		return [{ field : "sources", value : result}];
	}}]);
}
rg.controller.info.InfoDataContextReportGrid.__super__ = rg.controller.info.InfoDataContext;
rg.controller.info.InfoDataContextReportGrid.prototype = $extend(rg.controller.info.InfoDataContext.prototype,{
	__class__: rg.controller.info.InfoDataContextReportGrid
});
...
rg.JSBridge.main = function() {
	...
	if(null == r) rg.JSBridge.log(new thx.error.Error("unable to initialize the ReportGrid visualization system, be sure to have loaded already the 'reportgrid-core.js' script",null,null,{ fileName : "JSBridge.hx", lineNumber : 1, className : "rg.JSBridge", methodName : "main"}).toString());
	var executor = new rg.data.source.rgquery.ReportGridExecutorMemoryCache(r), app = new rg.controller.App(executor,t);
...
rg.controller.factory.FactoryDataSourceReportGrid = $hxClasses["rg.controller.factory.FactoryDataSourceReportGrid"] = function(cache,executor) {
	rg.controller.factory.FactoryDataSource.call(this,cache);
...
rg.controller.factory.FactoryDataSourceReportGrid.__super__ = rg.controller.factory.FactoryDataSource;
rg.controller.factory.FactoryDataSourceReportGrid.prototype = $extend(rg.controller.factory.FactoryDataSource.prototype,{
	parser: null
	,executor: null
	,create: function(info) {
		...
		return rg.controller.factory.FactoryDataSource.prototype.create.call(this,info);
	}
	...
	,createFromGraph: function(path,event,idproperty,parentproperty,whereConditions,start,end) {
		return new rg.data.source.DataSourceReportGridGraph(this.executor,path,event,idproperty,parentproperty,whereConditions,start,end);
	}
...
rg.data.source.DataSourceReportGrid = $hxClasses["rg.data.source.DataSourceReportGrid"] = function(executor,path,event,query,operation,tag,location,groupby,timezone,start,end) {
	...
	this.periodicity = (function($this) {
		...
		default:
			$r = (function($this) {
				var $r;
				throw new thx.error.Error("normalization failed, the last value should always be a Time expression",null,null,{ fileName : "DataSourceReportGrid.hx", lineNumber : 1, className : "rg.data.source.DataSourceReportGrid", methodName : "new"});
				return $r;
			}($this));
		}
		return $r;
	...
	this.where = query.where.map(function(d,i) {
		return (function($this) {
			...
			default:
				$r = (function($this) {
					var $r;
					throw new thx.error.Error("invalid data for 'where' condition",null,null,{ fileName : "DataSourceReportGrid.hx", lineNumber : 1, className : "rg.data.source.DataSourceReportGrid", methodName : "new"});
					return $r;
				}($this));
			}
			return $r;
	...
	if(exp.length > 1) {
		...
		while(_g1 < _g) {
			...
			if(rg.data.source.DataSourceReportGrid.isTimeProperty(exp[i])) {
				if(pos >= 0) throw new thx.error.Error("cannot perform intersections on two or more time properties",null,null,{ fileName : "DataSourceReportGrid.hx", lineNumber : 1, className : "rg.data.source.DataSourceReportGrid", methodName : "normalize"});
				pos = i;
			}
		}
...
rg.data.source.DataSourceReportGrid.prototype = {
	...
	,mapProperties: function(d,_) {
		...
		default:
			throw new thx.error.Error("normalization failed, only Property values should be allowed",null,null,{ fileName : "DataSourceReportGrid.hx", lineNumber : 1, className : "rg.data.source.DataSourceReportGrid", methodName : "mapProperties"});
		}
	}
	...
	,load: function() {
		var me = this;
		if(0 == this.exp.length) throw new thx.error.Error("invalid empty query",null,null,{ fileName : "DataSourceReportGrid.hx", lineNumber : 1, className : "rg.data.source.DataSourceReportGrid", methodName : "load"}); else if(this.exp.length == 1 && null == this.exp[0].property || this.where.length > 0) {
	...
	,error: function(msg) {
		throw new thx.error.Error(msg,null,null,{ fileName : "DataSourceReportGrid.hx", lineNumber : 1, className : "rg.data.source.DataSourceReportGrid", methodName : "error"});
	}
...
rg.controller.App.prototype = {
	...
	,visualization: function(el,jsoptions) {
		...
		var cache = new Hash();
		var params = rg.controller.info.Info.feed(new rg.controller.info.InfoVisualizationOptionReportGrid(),jsoptions);
		var factoryDataSource = new rg.controller.factory.FactoryDataSourceReportGrid(cache,this.executor);
...
rg.util.Js.findScript = function(fragment) {
	return ReportGrid.$.Util.findScript(fragment);
}
...
rg.data.source.rgquery.transform.TransformIntersectUtc.prototype = {
	...
	,transform: function(data) {
		...
		haxe.Log.trace(result,{ fileName : "TransformIntersectUtc.hx", lineNumber : 1, className : "rg.data.source.rgquery.transform.TransformIntersectUtc", methodName : "transform"});
		return result;
	}
...
rg.controller.info.InfoDataSourceReportGrid = $hxClasses["rg.controller.info.InfoDataSourceReportGrid"] = function() {
	rg.controller.info.InfoDataSource.call(this);
...
rg.controller.info.InfoDataSourceReportGrid.filters = function() {
	return [{ field : "query", validator : function(v) {
		...
		return Std["is"](v,Array);
	}, filter : null}].concat(rg.controller.info.InfoDataSource.filters());
}
...
rg.controller.info.InfoDataSourceReportGrid.__super__ = rg.controller.info.InfoDataSource;
rg.controller.info.InfoDataSourceReportGrid.prototype = $extend(rg.controller.info.InfoDataSource.prototype,{
	query: null
	,path: null
	,event: null
	,statistic: null
...
rg.data.source.DataSourceReportGridGraph = $hxClasses["rg.data.source.DataSourceReportGridGraph"] = function(executor,path,event,idproperty,parentproperty,whereConditions,start,end) {
	this.path = path;
	this.executor = executor;
	this.event = rg.data.source.DataSourceReportGridGraph.np(event);
	this.idproperty = rg.data.source.DataSourceReportGridGraph.np(idproperty);
	this.parentproperty = rg.data.source.DataSourceReportGridGraph.np(parentproperty);
	this.whereConditions = null == whereConditions?[]:whereConditions;
	this.timeStart = start;
	this.timeEnd = end;
	this.onLoad = new hxevents.Dispatcher();
}
rg.data.source.DataSourceReportGridGraph.__name__ = ["rg","data","source","DataSourceReportGridGraph"];
rg.data.source.DataSourceReportGridGraph.__interfaces__ = [rg.data.IDataSource];
rg.data.source.DataSourceReportGridGraph.np = function(v) {
	return StringTools.startsWith(v,".")?v:"." + v;
}
rg.data.source.DataSourceReportGridGraph.val = function(v) {
	if(v == "null") return null;
	if(v.substr(0,1) == "\"") return v.substr(1,v.length - 2);
	return Std.parseFloat(v);
}
rg.data.source.DataSourceReportGridGraph.prototype = {
	executor: null
	,path: null
	,event: null
	,idproperty: null
	...
	,load: function() {
		...
		while(_g < _g1.length) {
			var item = _g1[_g];
			++_g;
			properties.push({ property : this.event + rg.data.source.DataSourceReportGridGraph.np(item.property)});
		}
		this.executor.intersect(this.path,{ properties : properties},function(r) {
			...
			while(_g < _g1.length) {
				var key = _g1[_g];
				++_g;
				var id = rg.data.source.DataSourceReportGridGraph.val(key);
				if(null == id) continue;
				...
				while(_g2 < _g3.length) {
					...
					++_g2;
					where[me.event + rg.data.source.DataSourceReportGridGraph.np(condition.property)] = condition.value;
				}
				enqueue();
				...
				while(_g2 < _g3.length) {
					...
					var parent = rg.data.source.DataSourceReportGridGraph.val(kparent), cur = Reflect.field(relations,kparent);
	...
	,__class__: rg.data.source.DataSourceReportGridGraph
}
...
rg.data.source.rgquery.QueryParser.cleanName = function(name) {
	...
	while(_g < chars.length) {
		...
		if(pos < 0) throw new thx.error.Error("quoted property is not properly formatted",null,null,{ fileName : "QueryParser.hx", lineNumber : 1, className : "rg.data.source.rgquery.QueryParser", methodName : "cleanName"});
...
rg.data.source.rgquery.QueryParser.parseQuoted = function(s,q,results) {
	...
	if(pos < 0) throw new thx.error.Error("value is not correctly quoted",null,null,{ fileName : "QueryParser.hx", lineNumber : 1, className : "rg.data.source.rgquery.QueryParser", methodName : "parseQuoted"});
...
rg.data.source.rgquery.QueryParser.prototype = {
	...
	,processProperty: function(token) {
		...
		if(parts.length == 1) {
			if(!rg.data.source.rgquery.QueryParser.TOKEN_INDIVIDUAL_PARSE.match(token)) throw new thx.error.Error("invalid individual expression '{0}'",null,token,{ fileName : "QueryParser.hx", lineNumber : 1, className : "rg.data.source.rgquery.QueryParser", methodName : "processProperty"});
			...
			if(!rg.data.source.rgquery.QueryParser.TOKEN_FIRST_PARSE.match(parts[0])) throw new thx.error.Error("invalid first expression '{0}' in '{1}'",[parts[0],token],null,{ fileName : "QueryParser.hx", lineNumber : 1, className : "rg.data.source.rgquery.QueryParser", methodName : "processProperty"});
			...
			while(_g1 < _g) {
				var i = _g1++;
				if(!rg.data.source.rgquery.QueryParser.TOKEN_CONDITION_PARSE.match(parts[i])) throw new thx.error.Error("invalid expression condition '{0}' in '{1}'",[parts[i],token],null,{ fileName : "QueryParser.hx", lineNumber : 1, className : "rg.data.source.rgquery.QueryParser", methodName : "processProperty"});
	...
	,addWhereCondition: function(name,operator,value) {
		...
		case "=":
			...
			break;
		default:
			throw new thx.error.Error("invalid operator '{0}'",null,operator,{ fileName : "QueryParser.hx", lineNumber : 1, className : "rg.data.source.rgquery.QueryParser", methodName : "addWhereCondition"});
		}
	}
...
rg.controller.info.InfoVisualizationOptionReportGrid = $hxClasses["rg.controller.info.InfoVisualizationOptionReportGrid"] = function() {
	rg.controller.info.InfoVisualizationOption.call(this);
}
rg.controller.info.InfoVisualizationOptionReportGrid.__name__ = ["rg","controller","info","InfoVisualizationOptionReportGrid"];
rg.controller.info.InfoVisualizationOptionReportGrid.filters = function() {
	var filters = rg.controller.info.InfoVisualizationOption.filters();
	Arrays.removef(filters,function(item) {
		return item.field == "data";
	});
	return filters.concat([{ field : "data", validator : function(v) {
		return Std["is"](v,Array) || Reflect.isObject(v);
	}, filter : function(v) {
		return [{ field : "data", value : Std["is"](v,Array)?v.map(function(v1,i) {
			return rg.controller.info.Info.feed(new rg.controller.info.InfoDataContextReportGrid(),v1);
		}):[rg.controller.info.Info.feed(new rg.controller.info.InfoDataContextReportGrid(),v)]}];
	}}]);
}
rg.controller.info.InfoVisualizationOptionReportGrid.__super__ = rg.controller.info.InfoVisualizationOption;
rg.controller.info.InfoVisualizationOptionReportGrid.prototype = $extend(rg.controller.info.InfoVisualizationOption.prototype,{
	__class__: rg.controller.info.InfoVisualizationOptionReportGrid
});
...
rg.util.Urls.addQueryParameters = function(url,query) {
	return ReportGrid.$.Util.addQueryParameters(url,query);
}
rg.util.Urls.parseQueryParameters = function(url) {
	return ReportGrid.$.Util.parseQueryParameters(url);
}
...
rg.controller.factory.FactoryVariableReportGrid = $hxClasses["rg.controller.factory.FactoryVariableReportGrid"] = function() { }
rg.controller.factory.FactoryVariableReportGrid.__name__ = ["rg","controller","factory","FactoryVariableReportGrid"];
rg.controller.factory.FactoryVariableReportGrid.createFromDataContexts = function(contexts) {
...
rg.controller.factory.FactoryVariableReportGrid.prototype = {
	__class__: rg.controller.factory.FactoryVariableReportGrid
}
